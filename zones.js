...
// - keeperSprite / food / backgroundLayer : 지금은 비워두고, 나중에 값만 채우면
//   render.js가 자동으로 화면에 반영합니다 (구조는 이미 준비됨). backgroundLayer가
//   채워지면 habitatType 기본 CSS 그라디언트 대신 실제 픽셀아트 배경 이미지를 씁니다.
